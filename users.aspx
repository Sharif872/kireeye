<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="kireeye.users" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="form-group">
        ...
        <asp:TextBox ID="txtpass" CssClass="form-control" placeholder="Password"  required="" runat="server"></asp:TextBox>
            </div>
            
        <div class="form-group">
            <label>role</label>
           <asp:TextBox ID="txtrole" CssClass="form-control"  placeholder="role" required="" runat="server"></asp:TextBox>
        </div>
