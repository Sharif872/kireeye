<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jobs.aspx.cs" Inherits="kireeye.jobs" %>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard.aspx" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Restauranr System</span>
    </a>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
             ...
             <div class="card-header">
                    <h3 class="card-title">jobs form</h3>
                 </div>
             <!-- /.card-header -->
              <!-- form start -->
            ...
            <div class="card-body">
             ...
             <label >job title</label>
               <asp:TextBox ID="txtusername" CssClass="form-control" placeholder="job title"  required="" runat="server"></asp:TextBox>
            </div>
     <div class="form-group">
            <label >job describtion</label>
        <asp:TextBox ID="txtpass" CssClass="form-control" placeholder="job describtion"  required="" runat="server"></asp:TextBox>
            </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 021 <a href="https://adminlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
