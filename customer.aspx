<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer.aspx.cs" Inherits="kireeye.customer" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
             ...
             <label >customer name</label>
               <asp:TextBox ID="txtusername" CssClass="form-control" placeholder="customer name"  required="" runat="server"></asp:TextBox>
            </div>
     <div class="form-group">
        ...
        <div class="form-group">
            <label>email</label>
           <asp:TextBox ID="txtrole" CssClass="form-control"  placeholder="email" required="" runat="server"></asp:TextBox>
        </div>
